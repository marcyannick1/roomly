...
import { Mail, Lock, User, ArrowLeft, Home, Heart, Sparkles, Zap } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-5xl font-bold text-foreground mb-6" style={{ fontFamily: 'Outfit' }}>
              Rejoignez
              <br />
              <span className="text-primary">Roomly</span> aujourd'hui
            </h1>
            
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Créez votre compte et commencez votre recherche du logement parfait en quelques minutes.
            </p>

            {/* Feature Pills */}
            <div className="space-y-4">
              {[
                { icon: Zap, text: "Inscription rapide et gratuite" },
                { icon: Heart, text: "Matching intelligent avec les bailleurs" },
                { icon: Sparkles, text: "Trouvez votre chez-vous en un clin d'œil" }
              ].map((feature, index) => {
          ...
          >
            ...
            <div className="bg-card/80 backdrop-blur-xl rounded-3xl p-8 lg:p-10 shadow-2xl border border-border/50">
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">Rejoignez des milliers d'étudiants</p>
              </div>
