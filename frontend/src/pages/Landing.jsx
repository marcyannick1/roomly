...
const Landing = () => {
  ...
  const getDashboardPath = () => {
    ...
    return user.role === "student" ? "/student/dashboard" : "/landlord/dashboard";
  };
    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="flex items-center gap-3">
              {user ? (
                <Button
                  ...
                  className="bg-primary hover:bg-primary-hover text-black rounded-full px-6"
                ...
                <>
                  ...
                  <Link to="/register">
                    <Button className="bg-primary hover:bg-primary-hover text-black rounded-full px-6" data-testid="register-btn">
                      S'inscrire
                    </Button>
                  </Link>
                </>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 bg-primary-50 text-primary-800 px-4 py-2 rounded-full text-sm font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  onClick={() => navigate(getDashboardPath())}
                  className="bg-primary hover:bg-primary-hover text-black rounded-full px-8 py-6 text-lg font-semibold shadow-lg shadow-primary/20 transition-all active:scale-95"
              ...
              <div key={index} className="relative" data-testid={`step-${index + 1}`}>
                ...
                <div className="text-center">
                  <div className="relative inline-block mb-6">
                    ...
                    <span className="absolute -top-2 -right-2 w-8 h-8 bg-primary text-black rounded-full flex items-center justify-center text-sm font-bold">
                      {item.step}
                    </span>
                  </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button
            onClick={() => navigate(getDashboardPath())}
            className="bg-primary hover:bg-primary-hover text-black rounded-full px-10 py-6 text-lg font-semibold shadow-lg shadow-primary/20 transition-all active:scale-95"
