...
import { mockProperties, mockMatches } from "../mockData";
...
const StudentDashboard = () => {
  ...
  const handleSwipe = (action) => {
    ...
    try {
      // Simulate a random match (30% chance)
      if (Math.random() < 0.3 && action === "like") {
      ...
      <nav className="fixed bottom-0 left-0 right-0 glass border-t border-slate-100 z-40">
        <div className="max-w-md mx-auto px-6 py-3">
          <div className="flex items-center justify-around">
            ...
            <NavButton icon={Map} label="Carte" onClick={() => navigate('/map')} />
